 ...
 */
export function read_npz_file_encoder(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.read_npz_file_encoder(ptr0, len0);
    if (ret[1]) {
 ...
 * @param {Uint8Array} title_embeddings_data
 * @param {any} adjustments
 * @param {Uint8Array} aligner_weights
 * @param {Uint8Array} decoder_weights
 */
export function read_model_tensors(weights_data, config_string, tokenizer_bytes, title_embeddings_data, adjustments, aligner_weights, decoder_weights) {
    const ptr0 = passArray8ToWasm0(weights_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(config_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(tokenizer_bytes, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(title_embeddings_data, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passArray8ToWasm0(aligner_weights, wasm.__wbindgen_malloc);
    const len4 = WASM_VECTOR_LEN;
    const ptr5 = passArray8ToWasm0(decoder_weights, wasm.__wbindgen_malloc);
    const len5 = WASM_VECTOR_LEN;
    const ret = wasm.read_model_tensors(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, adjustments, ptr4, len4, ptr5, len5);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {QueryResult}
 */
export function text_query(query) {
    const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.text_query(ptr0, len0);
...
export class QueryResult {
     ...
     */
    get surface() {
        const ret = wasm.queryresult_surface(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Float32Array}
     */
    get volume() {
        const ret = wasm.queryresult_volume(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Float32Array}
     */
    get puborder() {
        const ret = wasm.queryresult_puborder(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('neuroencoder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
